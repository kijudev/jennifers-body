...
# Include OpenGL (GL) in pkg-config so libGL is linked as well
PKG_CFLAGS := $(shell $(PKG_CONFIG) --cflags glfw3 vulkan gl)
PKG_LIBS   := $(shell $(PKG_CONFIG) --static --libs glfw3 vulkan gl)
